...
def main():
    ...
    while running:
        ...
        if life_num and not paused:
            ...
            if not(delay % 100):
                for i in enemies:
                        if i.rect.top>10:
                            ...
                            #print(i.rect.midtop)
                            bullets_enemy[bullet3_index].reset(i.rect.midtop)
                    ...
                    if enemy_hit:
                        ...
                        for e in enemy_hit:
                            if e in mid_enemies or e in big_enemies:
                                ...
                                e.active = False
                    enemy_b = pygame.sprite.spritecollide(b, bullets_enemy, False, pygame.sprite.collide_mask)
                    if enemy_b:
                        
                        b.active = False
                        for e in enemy_b:
                            e.active = False
            for b in bullets_enemy:#检测敌方子弹是否击中飞机
                if b.active:
                    b.move()
                    screen.blit(b.image, b.rect)
                    player_hit = pygame.sprite.spritecollide(b, mes, False, pygame.sprite.collide_mask)
                    if player_hit:
                        b.active = False
                        me.active=False
                        print("被击中")
            ...
            score_text = score_font.render(str("kill: %s" % score), True, WHITE)
